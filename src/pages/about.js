      ...
      <Layout location={this.props.location} title={"about"}>
        ...
        <div class="section position-relative">
          <div class="container">
            <div class="col lg-7 block-centered md-12">
              <div class="pre-title-container">
                <div class="pre-title is-left-aligned">our achievements</div>
                <div class="pre-title-decoration"></div>
              </div>
              <h3>Setting standards others follow</h3>
            </div>
          </div>
          <div class="container">
            <div class="col lg-12">
              <div class="w-layout-grid c-grid-partner"><img src="https://uploads-ssl.webflow.com/5d638efb45d893a76c58d5ca/5d6496739883e8658a329add_logo9.svg" alt="" class="c-grid-partner__logo"/><img src="https://uploads-ssl.webflow.com/5d638efb45d893a76c58d5ca/5d6496736ed3eea8d79f5f11_logo5.svg" alt="" class="c-grid-partner__logo"/><img src="https://uploads-ssl.webflow.com/5d638efb45d893a76c58d5ca/5d6496719093d74769c2f9eb_logo2.svg" alt="" class="c-grid-partner__logo"/><img src="https://uploads-ssl.webflow.com/5d638efb45d893a76c58d5ca/5d64967299c8ff14c7d5e081_logo3.svg" alt="" class="c-grid-partner__logo"/><img src="https://uploads-ssl.webflow.com/5d638efb45d893a76c58d5ca/5d6496719883e8d31f329adb_logo7.svg" alt="" class="c-grid-partner__logo"/><img src="https://via.placeholder.com/1000x600.png?text=IMAGE" alt="" class="c-grid-partner__logo"/></div>
            </div>
          </div>
        ...
        <div class="section">
          ...
          <div class="container flex-horizontal">
            <div class="col lg-4 shift-down-quad md-12">
              <div class="c-team2"><img src="https://via.placeholder.com/1000x600.png?text=IMAGE" alt="" class="margin-bottom"/>
                <div class="is-bold">Howard Clarke, CEO</div>
              </div>
              <div class="c-team2"><img src="https://via.placeholder.com/1000x600.png?text=IMAGE" alt="" class="margin-bottom"/>
                <div class="is-bold">Richard Tinoko, Product Designer</div>
              </div>
            </div>
            <div class="col lg-4 shift-down-double md-12">
              <div class="c-team2"><img src="https://via.placeholder.com/1000x600.png?text=IMAGE" alt="" class="margin-bottom"/>
                <div class="is-bold">Brad Brookes, Managing Director</div>
              </div>
              <div class="c-team2"><img src="https://via.placeholder.com/1000x600.png?text=IMAGE" alt="" class="margin-bottom"/>
            ...
            <div class="col lg-4 flexv-space-between md-12 order-first">
              <div>
                <div class="pre-title-container">
                  <div class="pre-title is-left-aligned">meet our team</div>
                  <div class="pre-title-decoration"></div>
                </div>
                <h3 class="margin-bottom">A multi—disciplinary brilliant team of creators</h3>
                <div class="margin-bottom w-richtext">
        ...
        <div class="offcanvas-overlay">
          <div class="offcanvas-menu-list">
            <div data-w-id="87ab175b-2a43-c82a-1d28-52c5ecbe82b3" class="fa on-dark close-button-offcanvas"></div>
